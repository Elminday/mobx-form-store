...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FormStore = (_class = function () {
	  ...
	  function FormStore(options, data) {
	    ...
	    this.dataChanges = _mobx.observable.map ? _mobx.observable.map() : (0, _mobx.asMap)(); // changes that will be sent to server
	
	    // register observe for changes to properties in store.data as well as to complete replacement of store.data object
	    var storeDataChanged = observableChanged.bind(store);
	    store.observeDisposer = (0, _mobx.observe)(store.data, storeDataChanged);
	    (0, _mobx.observe)(store, 'data', function () {
	    ...
	    if (store.options.autoSaveInterval) {
	      (0, _mobx.autorunAsync)(function () {
	        if ((!store.options.idProperty || _this.data[store.options.idProperty]) && _this.dataChanges.keys().length) {
	  ...
	  _createClass(FormStore, [{
	    ...
	    value: function stopEditing() {
	      ...
	      if (store.status.hasChanges) {
	        ...
	        (0, _mobx.action)(function () {
	          var key = store.dataChanges.keys()[0];
	      ...
	      store.saveQueue = store.saveQueue.then(function () {
	        return new Promise(function ($return, $error) {
	          ...
	          if (saveAll) {
	            ...
	            try {
	              for (var _iterator = updates.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            updates = Object.assign.apply(Object, _toConsumableArray(Object.entries(updates).map(function (d) {
